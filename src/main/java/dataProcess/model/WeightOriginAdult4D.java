...
public class WeightOriginAdult4D {
    private Integer id;
    ...
    public WeightOriginAdult4D() {}

    private WeightOriginAdult4D(Builder b) {
        age = b.age;
        sex = b.sex;
    ...
    public static class Builder {
        ...
        public WeightOriginAdult4D build() {
            return new WeightOriginAdult4D(this);
        }
    }
}